...
/**
 * This is the extension manager of the Spartacustrainingaddon extension.
 */
public class SpartacustrainingaddonManager extends GeneratedSpartacustrainingaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SpartacustrainingaddonManager.class.getName());
	 ...
	 */
	public static SpartacustrainingaddonManager getInstance()
	{
		return (SpartacustrainingaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SpartacustrainingaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpartacustrainingaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SpartacustrainingaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SpartacustrainingaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SpartacustrainingaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
